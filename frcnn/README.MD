...
- [How does this sample work?](#heading-1)
    ...
    * [TensorRT API layers and ops](#sub-heading-6)
- [Running the sample](#heading-2)
    * [Sample `--help` options](#sub-heading-7)
- [Additional resources](#heading-3)
- [License](#heading-4)
- [Changelog](#heading-5)
- [Known issues](#heading-6)
