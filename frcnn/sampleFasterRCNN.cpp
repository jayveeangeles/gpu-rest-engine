...
static const int INPUT_H = 756; //375;
static const int INPUT_W = 1008; //500;
...
const std::string CLASSES[OUTPUT_CLS_SIZE]{"background", "98a056d4-36d0-4be8-9c1a-b391ea6bb7fe-gun", "98a056d4-36d0-4be8-9c1a-b391ea6bb7fe-photo-frame", "98a056d4-36d0-4be8-9c1a-b391ea6bb7fe-heart", "98a056d4-36d0-4be8-9c1a-b391ea6bb7fe-wave"};
                     ...
                     IHostMemory** trtModelStream)            // Output stream for the TensorRT model
{
    ...
    builder->setMaxWorkspaceSize(20 << 20); // We need about 6MB of scratch space for the plugin layer for batch size 5
...
int main(int argc, char** argv)
{
    ...
    std::vector<std::string> imageList = {"heart.ppm", "gun.ppm", "stop.ppm", "frame.ppm"};
